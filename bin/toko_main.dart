...
void main() {
  // Membuat produk
  var produk1 = Produk('Cooler Laptop', 130000, 20);
  var produk2 = Produk('Mouse Gaming', 90000, 12);
  var produk3 = Produk('Keyboard Gaming', 210000, 9);
